(async () => {
  ...
  const __vite__wasmUrl = "" + new URL("rem8x_bg-DAPUbzKF.wasm", import.meta.url).href;
  ...
  function load_instrument$1(song, at_index, arr) {
    _assertClass(song, WasmSong);
    const ret = wasm$1.load_instrument(song.__wbg_ptr, at_index, arr);
    if (ret[2]) {
      throw takeFromExternrefTable0(ret[1]);
    }
    return ret[0] !== 0;
  ...
  function show_phrase$1(song, is_left, phrase) {
    let deferred1_0;
    let deferred1_1;
    try {
      _assertClass(song, WasmSong);
      const ret = wasm$1.show_phrase(song.__wbg_ptr, is_left, phrase);
      deferred1_0 = ret[0];
      deferred1_1 = ret[1];
      return getStringFromWasm0(ret[0], ret[1]);
    } finally {
  ...
  function show_table$1(song, is_left, table) {
    let deferred1_0;
    let deferred1_1;
    try {
      _assertClass(song, WasmSong);
      const ret = wasm$1.show_table(song.__wbg_ptr, is_left, table);
      deferred1_0 = ret[0];
      deferred1_1 = ret[1];
      return getStringFromWasm0(ret[0], ret[1]);
    } finally {
  ...
  function __wbg_length_ab6d22b5ead75c72(arg0) {
    const ret = arg0.length;
    return ret;
  }
  function __wbg_new_07b483f72211fd66() {
  ...
  function __wbg_newfromslice_7c05ab1297cb2d88(arg0, arg1) {
    const ret = new Uint8Array(getArrayU8FromWasm0(arg0, arg1));
    return ret;
  }
  function __wbg_newfromslice_bcd6b1e87ab624a5(arg0, arg1) {
  ...
  function __wbg_set_c43293f93a35998a() {
  ...
  function __wbg_setindex_4a584e615586b3af(arg0, arg1, arg2) {
    arg0[arg1 >>> 0] = arg2;
  }
  ...
  const __vite__wasmModule = await __vite__initWasm({
    "./rem8x_bg.js": {
      ...
      __wbg_new_58353953ad2097cc,
      __wbg_new_07b483f72211fd66,
      __wbg_push_73fd7b5550ebf707,
      __wbg_buffer_a1a27a0dfa70165d,
      __wbg_newwithbyteoffsetandlength_3b01ecda099177e8,
      __wbg_new_e52b3efaaa774f96,
      __wbg_set_fe4e79d1ed3b0e9b,
      __wbg_length_ab6d22b5ead75c72,
      __wbg_newwithlength_08f872dc1e3ada2e,
      __wbg_newfromslice_7c05ab1297cb2d88,
      __wbg_setindex_4a584e615586b3af,
      __wbg_newfromslice_bcd6b1e87ab624a5,
      __wbg_set_c43293f93a35998a,
      __wbindgen_throw,
      __wbindgen_memory,
  ...
  const load_instrument = __vite__wasmModule.load_instrument;
  ...
  function highlight_view(pane, view) {
  }
  function fixViewId(pane, view_id, elem_id) {
    var views = [
      ...pane.song_views.value
    ];
  ...
  function closeView(pane, view_id) {
    var views = [
      ...pane.song_views.value
    ];
    for (let i2 = 0; i2 < views.length; i2++) {
  ...
  function openHighlightElem(pane, kind, elem_id) {
  ...
  function initPane(side) {
    return {
      ...
      edited_view: d$1(void 0),
      selection_range: d$1(void 0),
      empty_selection: d$1(7),
      song_views: d$1([]),
      fresh_view_id: 0,
  ...
  function paneOfSide(state2, side) {
    switch (side) {
      case "left":
        return state2.left;
      case "right":
  ...
  function InstrumentList(props) {
    ...
    const allow_new_edit = current_edit_name === void 0;
    ...
    for (const vix of instruments) {
      ...
      const open_instrument = () => {
        openHighlightElem(paneOfSide(state2, props.side), "instrument", vix);
      };
      elems.push(u$2("div", {
        class: "instr",
        children: [
  ...
  function ChainViewer(props) {
    ...
    const chainSteps = get_chain_steps$1(song, props.chain_idx);
    const elems = [];
    const phraseSet = (i2) => openHighlightElem(props.panel, "phrase", i2);
  ...
  async function loadInstrument(state2, song, buff) {
    const loaded_file = new Uint8Array(await buff);
    try {
      load_instrument$1(song, 0, loaded_file);
    } catch (err) {
      state2.message_banner.value = err.toString();
    }
  }
  async function loadDroppedSong(state2, ev, pane, emptyUrl) {
    ev.preventDefault();
      ...
      [
        ...
        if (item.kind === "file") {
          ...
          if (file.name.endsWith("m8i")) {
            const song = await loadUrl(state2, pane, emptyUrl);
            await loadInstrument(state2, song, file.arrayBuffer());
  ...
  async function loadUrl(state2, pane, url) {
    ...
    return await loadFile(state2, pane, loaded);
  }
      ...
      for (let col = 0; col < 8; col++) {
        ...
        if (chain === 255) {
          ...
          const elem = u$2("span", {
            ...
            onDragOver: (evt) => dragOver(evt),
            onDrop: (evt) => dragEnd(evt, line, col),
            onClick: () => openHighlightElem(props.pane, "chain", chain),
            children: [
              hexStr(chain),
              " "
            ]
  ...
  function SongHeader(props) {
    ...
    const leftCollapse = panel.side !== "left" ? void 0 : u$2(b$1, {
      children: [
        u$2("button", {
          title: "Collapse side",
          class: "collapseBtn",
          onClick: () => panel.closed.value = !isClosed,
          children: UnicodeSideIcon("left") + UnicodeSideAction(isClosed ? "left" : "right")
        }),
        isClosed ? void 0 : u$2("span", {
          class: "separator"
        })
      ]
    });
    const rightCollapse = panel.side !== "right" ? void 0 : u$2(b$1, {
      children: [
        isClosed ? void 0 : u$2("span", {
          class: "separator"
        }),
        u$2("button", {
          ...
          children: UnicodeSideAction(isClosed ? "right" : "left") + UnicodeSideIcon("right")
        })
      ]
    });
      ...
      return u$2("div", {
        ...
        children: [
          u$2("div", {
            children: [
              ...
              u$2("select", {
                ...
                onChange: (evt) => panel.empty_selection.value = parseInt(evt.target.value, 10),
                children: [
                  u$2("option", {
                    value: "4",
                    selected: selectedVersion === 4,
                    children: "M8 FW 4.0 empty song"
                  }),
                  u$2("option", {
                    value: "5",
                    selected: selectedVersion === 5,
                    children: "M8 FW 5.0 empty song"
                  }),
                  u$2("option", {
                    value: "6",
                    selected: selectedVersion === 6,
                    children: "M8 FW 6.0 empty song"
                  }),
                  u$2("option", {
                    value: "7",
                    selected: selectedVersion === 7,
                    children: "M8 FW 6.2 empty song"
                  })
                ]
              }),
              u$2("button", {
                onClick: () => loadUrl(state2, panel, versionUrlMapping[selectedVersion]),
                children: "Load"
              }),
              rightCollapse
            ]
          ...
          u$2("div", {
            ...
            onDrop: (evt) => loadDroppedSong(state2, evt, props.panel, versionUrlMapping[selectedVersion]),
            children: u$2("span", {
              children: "Drag M8 song or instrument file here"
            })
          })
        ]
      });
  ...
  function PhraseList(props) {
    ...
    for (const vix of phrases) {
      ...
      bucket.push(u$2("span", {
        onClick: () => openHighlightElem(props.pane, "phrase", vix),
        class: "phrase-link",
        children: [
          hexStr(vix),
          " "
  ...
  function PhraseViewer(props) {
    ...
    return u$2("pre", {
      dangerouslySetInnerHTML: {
        __html: show_phrase$1(song, isLeft, props.phrase_idx)
      }
    });
  }
  function TableViewer(props) {
    ...
    return u$2("pre", {
      dangerouslySetInnerHTML: {
        __html: show_table$1(song, isLeft, props.table_idx)
      }
    });
  }
  function ChainList(props) {
    ...
    const elems = [];
    const state2 = x(GlobalState);
    const current_edit = props.pane.edited_chain.value;
    ...
    let prevPhrase = phrases.length > 0 ? phrases[0] : 0;
    for (const vix of phrases) {
      const toggle_phrase = () => props.pane.edited_chain.value = {
        x: -1,
        y: -1,
        view_index: -1,
        base_value: vix,
      ...
      const id_change = (v2) => props.pane.edited_chain.value = {
        ...current_edit,
        current_value: v2
      };
      const id_validate = (v2) => {
        props.pane.edited_chain.value = void 0;
        try {
      ...
      bucket.push(edited_chain.base_value === vix ? u$2(HexNumberEditor, {
        ...
        onCancel: () => props.pane.edited_chain.value = void 0,
  ...
  function TableList(props) {
    ...
    for (const vix of phrases) {
      ...
      prevPhrase = vix;
      bucket.push(u$2("span", {
        onClick: () => openHighlightElem(props.pane, "table", vix),
        class: "table-link",
        children: [
          hexStr(vix),
          " "
  ...
  function RootDescriptorRender(props) {
    ...
    if ("nest" in desc) {
      ...
      const eqValue = eq >= 128 ? "--" : u$2("span", {
        class: "eq-link",
        onClick: () => openHighlightElem(pane, "equ", eq),
        children: hexStr(eq)
      });
      return u$2("div", {
        class: "instrparam",
              ...
              u$2("span", {
                children: [
                  ...
                  u$2("span", {
                    ...
                    onClick: () => openHighlightElem(pane, "table", instr),
                    children: hexStr(tblTic)
                  })
                ]
              }),
              "\xA0\xA0",
  ...
  function InstrumentViewer(props) {
    ...
    let info = [];
    try {
      info = describe_instrument$1(song, props.instr_id);
    } catch (err) {
      state2.message_banner.value = err.toString();
      return void 0;
    }
  ...
  function EqList(props) {
    ...
    for (const vix of eqs) {
      ...
      bucket.push(u$2("span", {
        class: "eq-link",
        onClick: () => openHighlightElem(props.pane, "equ", vix),
        children: [
          hexStr(vix),
          " "
        ]
  ...
  function InstrumentView(props) {
    ...
    return u$2("div", {
      ...
      children: [
        ...
        eq >= 0 && eq < 128 && !isMidi ? u$2(EqViewerAt, {
          panel: props.panel,
          banner: props.banner,
          eq
        }) : void 0
  ...
  globalThis.show_instrument = (side, n2) => {
    const pane = side === "l" ? state.left : state.right;
    openHighlightElem(pane, "instrument", n2);
  };
  globalThis.show_table = (side, n2) => {
    const pane = side === "l" ? state.left : state.right;
    openHighlightElem(pane, "table", n2);
  };
  globalThis.show_eq = (side, n2) => {
    const pane = side === "l" ? state.left : state.right;
    openHighlightElem(pane, "equ", n2);
  };
  function EditControls(props) {
    ...
    const renumbering = props.canRenumber !== void 0 && !props.canRenumber(selectedElement) ? void 0 : edited === void 0 || edited.view_index !== props.view_index ? u$2(RenumberButton, {
      name,
    ...
    const control = selectedElement !== void 0 && props.onCopy !== void 0 ? u$2(CopyElement, {
      name,
      from_side: side,
    ...
    return u$2("span", {
      ...
      children: [
        ...
        u$2(CloseElement, {
          from_side: side,
          onClick: () => closeView(panel, props.view_index)
        })
      ]
    });
  }
  ...
  function PhraseElementView(props) {
  ...
  function ChainElementView(props) {
    const side = props.pane.side;
    const bump = props.pane.bumper.value;
    const { view_index, elem_id } = props.elem;
  ...
  function InstrumentElementView(props) {
    const side = props.pane.side;
    const bump = props.pane.bumper.value;
    const { view_index, elem_id } = props.elem;
  ...
  function TableElementView(props) {
    const side = props.pane.side;
    const bump = props.pane.bumper.value;
    const { view_index, elem_id } = props.elem;
  ...
  function SongElementView(props) {
    ...
    switch (elem.kind) {
      case "phrase":
        return u$2(PhraseElementView, {
          pane: props.pane,
          undoRedo: props.undoRedo,
          other_pane: props.other_pane,
          banner: props.banner,
          elem
        });
      case "chain":
        return u$2(ChainElementView, {
          pane: props.pane,
          undoRedo: props.undoRedo,
          other_pane: props.other_pane,
          banner: props.banner,
      ...
      case "instrument":
        return u$2(InstrumentElementView, {
          pane: props.pane,
          undoRedo: props.undoRedo,
          other_pane: props.other_pane,
          banner: props.banner,
  ...
  function SongExplorer(props) {
    ...
    props.pane.side;
    props.pane.bumper.value;
    const songViews = props.pane.song_views.value.map((view) => u$2(SongElementView, {
      elem: view,
      pane: props.pane,
      undoRedo: props.undoRedo,
      other_pane: props.other_pane,
  ...
  function App() {
    ...
    const leftView = state.left.closed.value ? void 0 : state.left.active_view.value === "song" ? u$2("div", {
      class: "rootcontent",
      children: [
        u$2(SongExplorer, {
          pane: state.left,
    ...
    const rightView = state.right.closed.value ? void 0 : state.right.active_view.value === "song" ? u$2("div", {
      class: "rootcontent",
      children: [
        u$2(SongViewer, {
          panel: state.right,
    ...
    return u$2(b$1, {
      children: [
        ...
        u$2("div", {
          ...
          children: [
            u$2("div", {
              class: state.left.closed.value ? "rootcollape" : "rootheader",
              children: [
                u$2(SongHeader, {
                  panel: state.left
                }),
            ...
            u$2("div", {
              class: state.right.closed.value ? "rootcollape" : "rootheader",
              children: [
                u$2(SongHeader, {
                  panel: state.right
                }),
