...
import { ChainNumberEdition, EmptyChainEdition, GlobalState, openHighlightElem, SongPane } from "../state";
...
export function ChainList(props: { song: W.WasmSong, pane: SongPane }) {
  ...
  for (const vix of phrases) {
    ...
    const id_change = (v: number) =>
      props.pane.edited_chain.value = { ...current_edit, current_value: v };
